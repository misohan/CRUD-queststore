...
<%@ page import="codecooler.michal.com.model.Mentor" %>
<head>
    <meta charset="UTF-8">
...
<div class="topnav">
    ...
    <a href="/Codecooler">Codecooler</a>
    <a href="/MentorForm">Mentor</a>
    <a href="../loginPage.html" target="_blank">>Login page</a>
...
<div class="row">
    ...
    <div class="column">
        <div class="card">
            <%Mentor mentor = (Mentor) request.getAttribute("mentorPut");%>
            ...
            <div class="form">
                <form action="/action_page.php">
                    ...
                    <input type="text" value="<%=mentor.getFirstName()%>"  name="fname"><br><br>
                    <label for="lname">Last name:</label><br>
                    <input type="text" value="<%=mentor.getLastName()%>"  name="lname"><br><br>
                ...
                <table border="1" cellpadding="5">
                    ...
                    <c:forEach var="mentor" items="${listMentor}">
                        <tr>
                            ...
                            <td>
                                <a href="/update?id=<c:out value='${mentor.id}' />">Edit</a>
...
<div class="footer">
    <h2><img src="/css/images/logo.png">MMK Developers©</h2>
</div>
</body>
</html>