...
<body>
  ...
  <div class="topnav">
    ...
    <a href="../mentorCodecoolerView">Codecoolers</a>
    <a href="../mentorArtifacts">Artifacts</a>
    <a href="../mentorQuests">Quest</a>
    ...
    <div class="column">
      <div class="card">
        ...
        <div id="codecooler" class="vis">
          <div class="form">
            <form action="/addCCMentorViewCodecooler" method="post">
                <label>Id:</label><br>
